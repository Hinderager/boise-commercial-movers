...
export const metadata: Metadata = {
  ...
  description: 'Professional warehouse relocation in Boise. Move inventory, racking, equipment, and operations with minimal downtime. Licensed and insured. Call (208) 768-3987.',
  alternates: {
