...
export const metadata: Metadata = {
  ...
  description: 'Professional medical equipment moving in Boise. Move exam tables, imaging equipment, and medical devices safely. Licensed and insured. Call (208) 768-3987.',
  alternates: {
