...
export const metadata: Metadata = {
  ...
  description: 'Complete business moving services in Boise. We handle everything from packing to setup at your new location. Minimize downtime. Call (208) 768-3987.',
  alternates: {
