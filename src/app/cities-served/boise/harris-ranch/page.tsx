...
export const metadata: Metadata = {
  title: 'Commercial Moving Harris Ranch Boise | Top Shelf',
  description: 'Commercial Moving services in Harris Ranch, Boise, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['commercial moving Harris Ranch', 'commercial moving Harris Ranch Boise', 'Harris Ranch boise commercial moving'],
  alternates: {
    canonical: 'https://boise-commercial-movers.com/cities-served/boise/harris-ranch',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Commercial Moving in Harris Ranch
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Harris Ranch residents trust us for commercial moving. Here's why.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Commercial Moving in Harris Ranch, Boise
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Harris Ranch area businesses trust us for office relocations and commercial moves. We work around your schedule to minimize business disruption.</p>
                <p>
