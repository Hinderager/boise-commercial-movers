...
export const metadata: Metadata = {
  title: 'Commercial Moving Karcher Nampa | Top Shelf',
  description: 'Commercial Moving services in Karcher, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['commercial moving Karcher', 'commercial moving Karcher Nampa', 'Karcher nampa commercial moving'],
  alternates: {
    canonical: 'https://boise-commercial-movers.com/cities-served/nampa/karcher',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Commercial Moving in Karcher
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving Karcher with professional commercial moving services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Commercial Moving in Karcher, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Commercial moves along Karcher Road. Professional service.</p>
                <p>
