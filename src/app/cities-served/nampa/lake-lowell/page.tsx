...
export const metadata: Metadata = {
  title: 'Commercial Moving Lake Lowell Nampa | Top Shelf',
  description: 'Commercial Moving services in Lake Lowell, Nampa, Idaho. Local team, fair prices, same-day service available. Call (208) 943-5231.',
  keywords: ['commercial moving Lake Lowell', 'commercial moving Lake Lowell Nampa', 'Lake Lowell nampa commercial moving'],
  alternates: {
    canonical: 'https://boise-commercial-movers.com/cities-served/nampa/lake-lowell',
  },
}
      ...
      <section className="relative py-16 md:py-24 bg-dark-blue">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">
            Commercial Moving in Lake Lowell
          </h1>
          <p className="text-xl text-gray-200 max-w-2xl mb-6">
            Serving Lake Lowell with professional commercial moving services.
          </p>
          <a
            href="tel:2089435231"
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-dark-blue mb-4">
                Commercial Moving in Lake Lowell, Nampa
              </h2>
              <div className="prose prose-lg max-w-none text-gray-600">
                <p>Commercial equipment moves in the Lake Lowell area. Agricultural and business.</p>
                <p>
