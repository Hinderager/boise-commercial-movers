...
export const metadata: Metadata = {
  ...
  description: 'Join our commercial moving team in Boise. Competitive pay, steady work, and professional environment. Apply for moving positions today. Call (208) 768-3987.',
  alternates: {
